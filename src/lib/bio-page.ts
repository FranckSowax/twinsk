...
// Contenus par défaut : propres à chaque pays (src/content/<code>).
export const DEFAULT_BIO_STEPS: BioStep[] = CONTENT.bio.steps;

export const DEFAULT_BIO_CONFIG: BioConfig = {
  title: CONTENT.bio.title,
  tagline: CONTENT.bio.tagline,
  logo_url: null,
  listings: [],
  steps: DEFAULT_BIO_STEPS,
  contacts: {
    whatsapp_number: COUNTRY.supportWhatsapp,
    whatsapp_channel: COUNTRY.social.whatsappChannel || '',
    whatsapp_group: COUNTRY.social.whatsappGroup || '',
    facebook: COUNTRY.social.facebook || '',
    instagram: COUNTRY.social.instagram || '',
    tiktok: COUNTRY.social.tiktok || '',
    youtube: '',
    email: '',
  },
};
