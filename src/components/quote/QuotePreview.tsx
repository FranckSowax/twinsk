    ...
    <div className="mx-auto max-w-4xl">
      ...
      <div className="rounded-3xl border border-slate-200 bg-white p-8 shadow-xl print:border-none print:shadow-none sm:p-12 dark:border-slate-700 dark:bg-slate-800">
        ...
        <div className="flex items-start justify-between gap-8 pb-6">
          <div className="flex h-28 w-28 flex-shrink-0 flex-col items-center justify-center rounded-full border-2 border-slate-900 bg-white text-slate-900">
            <p className="text-[8px] tracking-widest">TWINSK</p>
            <div className="my-1 h-px w-12 bg-slate-900" />
            <p className="font-display text-base font-bold tracking-tight">HONG KONG</p>
            <div className="my-1 h-px w-12 bg-slate-900" />
            <p className="text-[7px] tracking-wider">COMPANY LIMITED</p>
          </div>
