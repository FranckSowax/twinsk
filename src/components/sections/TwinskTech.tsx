...
const TwinskTech = () => {
  return (
    <>
      ...
      {/* Section 2 - Sourcing Marketplaces Chinoises */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.h2
                ...
                className="text-5xl md:text-6xl font-display font-medium uppercase tracking-tight leading-[0.9] mb-8 text-slate-900"
              >
                Sourcing sur les <br /> Marketplaces <br /> Chinoises
              </motion.h2>
              <motion.p
                variants={fadeInUp}
                transition={{ delay: 0.2 }}
                className="text-slate-600 text-lg font-light mb-10 max-w-lg leading-relaxed"
              >
                Accédez aux plus grandes plateformes e-commerce chinoises : <strong>Taobao</strong>, <strong>1688</strong>, <strong>Pinduoduo</strong>, <strong>Tmall</strong> et bien d&apos;autres. Notre équipe recherche, négocie et achète pour vous les meilleurs produits aux prix usine, avec vérification qualité avant expédition.
              </motion.p>

              {/* Marketplace logos/badges */}
              <motion.div
                variants={fadeInUp}
                transition={{ delay: 0.25 }}
                className="flex flex-wrap gap-3 mb-8"
              >
                {['Taobao', '1688', 'Pinduoduo', 'Tmall', 'JD.com'].map((platform) => (
                  <span
                    key={platform}
            ...
            >
              ...
              >
                <div className="relative h-[500px] w-full">
                  <Image
                    src="/replicate-prediction-78d0daq38srmr0cvntt8nwgxbr.jpg"
                    alt="Sourcing Marketplaces Chinoises"
                    fill
                    className="object-cover rounded-[2rem]"
                  />
                </div>
              ...
              <motion.div
                ...
                transition={{ delay: 0.5, type: 'spring' }}
                whileHover={{ scale: 1.05, y: -5 }}
                className="hidden lg:block absolute -left-16 top-1/2 -translate-y-1/2 z-20 bg-orange-100/90 backdrop-blur-sm p-6 rounded-2xl shadow-xl w-64"
              >
                <div className="flex justify-between items-start mb-4">
                  <span className="text-xs font-semibold text-slate-700">Service Sourcing</span>
                  <ArrowUpRight className="w-4 h-4 text-slate-700" />
                </div>
                <motion.div
                  whileHover={{ rotate: 360 }}
                ...
                <h4 className="font-display font-medium text-slate-900 text-xl uppercase leading-none">
                  +50 Marketplaces <br /> accessibles
                </h4>
              </motion.div>
            </motion.div>
          </div>
