  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="sticky bottom-0 z-10 flex flex-wrap items-center gap-2 border-t border-slate-200 bg-white/95 backdrop-blur px-6 py-4 dark:border-slate-700 dark:bg-slate-800/95">
          <button
            onClick={() => onDelete(row.id)}
            className="inline-flex items-center gap-1.5 rounded-lg p-2 text-sm text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20"
            aria-label="Supprimer"
            title="Supprimer"
          >
            <Trash2 className="h-4 w-4" />
          ...
          {/* Quote actions — moved here, sticky footer */}
          <button
            onClick={handleSaveQuote}
            disabled={savingQuote}
            className="inline-flex items-center gap-1.5 rounded-lg bg-slate-100 text-slate-700 px-3 py-2 text-sm font-semibold hover:bg-slate-200 disabled:opacity-50 dark:bg-slate-700 dark:text-slate-200"
          >
          ...
          {whatsappLink && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 rounded-lg bg-emerald-500 text-white px-3 py-2 text-sm font-semibold hover:bg-emerald-600"
            >
